  ...
  return (
    ...
    <div className='flex flex-col gap-5 md:gap-14 md:flex-row items-center'>
        ...
        <div>
            ...
            <p className='text-gray-600 mb-4'>Easily bring your ideas to life with our free AI image generator.whether you need stunning visuals or unique imagery, our tool transforms your text into eye-catching images with just a few clicks. Imagine it,describe it, and come to life instantly.</p>
